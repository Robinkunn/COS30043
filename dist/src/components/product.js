    ...
    const addToCart = async (item) => {
      ...
      try {
        ...
        if (!cart || !cart.id || cart.user_id !== user.id) {
          const cartResponse = await fetch(`https://us-central1-pizzahat.cloudfunctions.net/proxyAPI/api_carts.php?user_id=${user.id}`);
        ...
        const addItemResponse = await fetch('https://us-central1-pizzahat.cloudfunctions.net/proxyAPI/api_cart_items.php', {
          method: 'POST',
          headers: {
